...
render(){
  var dataSaleThumb = [
    {
      id: 1,
      categories: '10 % and above'
    },
    {
      id: 2,
      categories: '20 % and above'
    },
    {
      id: 3,
      categories: '30 % and above'
    },
    {
      id: 4,
      categories: '50 % and above'
    },
    {
      id: 5,
      categories: '60 % and above'
    }
               ...
               <Col style={{ backgroundColor: '#FFFFFF' }}>
                 <View >
                   ...
                   <TouchableOpacity >
                       ...
                       <Text style={{ fontSize: 12, fontWeight: '300', color: '#777' }}>120</Text>
                       </View>
                   </TouchableOpacity>}>
                   </List>
                 </View>
